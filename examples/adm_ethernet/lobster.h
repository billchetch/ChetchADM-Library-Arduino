...
#define ETHERNET_INIT_PIN 53 //se to -1 to use default 
#define ETHERNET_BEGIN_TIMEOUT 5000 //this is so we get the opportunity to do an led flash or something 
#define HOSTNAME "lobster" //change this per board
#define PORT 8091 //change this per board
byte mac[] = {  0x00, 0xAD, 0xBE, 0xEF, 0xFE, 0xEA }; //change this per board
IPAddress ip(192, 168, 0, 11); //change this per board
...
IPAddress networkServiceServerIP(192, 168, 0, 188);
